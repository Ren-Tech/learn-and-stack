...
const Preschool = () => {
  ...
  // Preschool specific images for mobile - using PNGs
  const preschoolImages = [
    { src: '/images/landscape/pre1.png', alt: 'Preschool Activity 1', title: 'Creative Play' },
    { src: '/images/landscape/pre2.png', alt: 'Preschool Activity 2', title: 'Learning Fun' },
    { src: '/images/landscape/pre3.png', alt: 'Preschool Activity 3', title: 'Group Activities' },
    { src: '/images/landscape/pre4.png', alt: 'Preschool Activity 4', title: 'Art & Craft' },
    { src: '/images/landscape/pre5.png', alt: 'Preschool Activity 5', title: 'Story Time' },
    { src: '/images/landscape/pre6.png', alt: 'Preschool Activity 6', title: 'Music & Dance' },
    { src: '/images/landscape/pre7.png', alt: 'Preschool Activity 7', title: 'Outdoor Play' },
    { src: '/images/landscape/pre8.png', alt: 'Preschool Activity 8', title: 'Building Blocks' },
    { src: '/images/landscape/pre9.png', alt: 'Preschool Activity 9', title: 'Puzzle Time' },
    { src: '/images/landscape/pre10.png', alt: 'Preschool Activity 10', title: 'Water Play' },
    { src: '/images/landscape/pre11.png', alt: 'Preschool Activity 11', title: 'Nature Explore' }
  ];
  ...
  const assessmentCategories = [
    { title: "Colors", gradient: "from-purple-600 via-purple-500 to-pink-500", shadow: "shadow-purple-500/50", glow: "shadow-purple-400", angle: -60, href: "/colors-assessment" },
    { title: "Shapes", gradient: "from-blue-600 via-blue-500 to-cyan-500", shadow: "shadow-blue-500/50", glow: "shadow-blue-400", angle: -20, href: "/shapes-assessment" },
    { title: "Numbers", gradient: "from-green-600 via-green-500 to-emerald-500", shadow: "shadow-green-500/50", glow: "shadow-green-400", angle: 20, href: "/numbers-assessment" },
    { title: "Letters", gradient: "from-orange-600 via-orange-500 to-yellow-500", shadow: "shadow-orange-500/50", glow: "shadow-orange-400", angle: 60, href: "/letters-assessment" }
  ];
  ...
  // Function to determine ninja position - UPDATED with -4rem margin for PC
  ...
  // Ninja dialog typing animation - REMOVED since we're removing the dialog
  useEffect(() => {
    ...
    <div className={`min-h-screen bg-white relative overflow-x-hidden ${showPortraitLock ? 'backdrop-blur-sm' : ''}`} onClick={handleContainerClick}>
      ...
      {useBbcLayout ? (
        ...
        <div className={`w-full h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 overflow-y-auto ${showPortraitLock ? 'blur-sm' : ''}`}>
          ...
          <div className="sticky top-0 left-0 right-0 h-8 bg-gradient-to-r from-pink-500 to-purple-600 z-40 flex items-center px-4">
      ...
      <div className="fixed inset-0 z-40 pointer-events-none">
        ...
        {/* Ninja Image without Dialog - Responsive Positioning with 20rem size for PC and -4rem margin */}
