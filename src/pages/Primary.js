          ...
          <div className="p-4">
            ...
            <div className="mb-6">
              <div className="bg-white rounded-lg overflow-hidden shadow-lg border border-gray-200">
                ...
                />
                <div className="p-4">
                  <h1 className="text-xl font-bold text-gray-900 mb-2">Primary School Education</h1>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              {primaryImages.slice(1, 3).map((image, index) => (
            ...
            <div className="mb-6">
              ...
              <div className="space-y-4">
                {primaryImages.slice(3).map((image, index) => (
