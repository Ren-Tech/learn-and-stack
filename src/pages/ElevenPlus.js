...
const ElevenPlus = () => {
  ...
  const assessmentCategories = [
    { title: "Verbal", gradient: "from-purple-600 via-purple-500 to-pink-500", shadow: "shadow-purple-500/50", glow: "shadow-purple-400", angle: -60, href: "/verbal-assessment" },
    { title: "Non-Verbal", gradient: "from-blue-600 via-blue-500 to-cyan-500", shadow: "shadow-blue-500/50", glow: "shadow-blue-400", angle: -20, href: "/nonverbal-assessment" },
    { title: "Math", gradient: "from-green-600 via-green-500 to-emerald-500", shadow: "shadow-green-500/50", glow: "shadow-green-400", angle: 20, href: "/math-assessment" },
    { title: "English", gradient: "from-orange-600 via-orange-500 to-yellow-500", shadow: "shadow-orange-500/50", glow: "shadow-orange-400", angle: 60, href: "/english-assessment" }
  ];
  ...
  useEffect(() => {
    ...
    // Prevent scrolling when portrait lock is active
    ...
    // Add scroll prevention when portrait lock is active
    if (showPortraitLock) {
  ...
  return (
    <div className={`min-h-screen bg-white relative ${showPortraitLock ? 'overflow-hidden' : 'overflow-x-hidden'}`} onClick={handleContainerClick}>
      {/* Portrait Lock Dialog - Fixed at highest z-index */}
      {showPortraitLock && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-md p-4">
      ...
      {/* Main Content - Conditionally blurred and scrollable */}
      <div className={`relative z-0 ${showPortraitLock ? 'blur-sm pointer-events-none' : ''}`}>
        {useBbcLayout ? (
